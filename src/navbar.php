...
<body>
    ...
    <nav style="background-color: rgba(255, 255, 255, 0.75);" class="fixed top-0 left-0 w-full z-50 border">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul class="font-semibold text-2xl flex flex-col p-4 md:p-0 mt-4 border md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 justify-between items-center">
                    ...
                    ?>
                        ...
                        <a href="signup.php" type="button" class="text-black bg-white hover:bg-gray-100 border focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-lg px-3 py-1 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 rajdhani-light" onclick="signout();">Sign Out</a>
                    ...
                    ?>
                        ...
                        <li>
                            <a href="signup.php" type="button" class="block text-white  bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-lg px-3 py-1 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700 rajdhani-light ">Sign Up</a>
                        </li>
