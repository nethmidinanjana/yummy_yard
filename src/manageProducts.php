        ...
        <div class="content">
            <div class="flex flex-col w-full h-full items-center px-9">
                ...
                <div class="w-full mt-5">
                    <span class="text-3xl rajdhani-light font-semibold">Manage Products</span>
                </div>
                ...
                <div class="w-full mt-6">
                    ...
                    <div class="flex flex-col flex-wrap justify-center items-center lg:flex-row gap-4 w-full px-6">
                        ...
                        <div class="w- lg:w-1/4 mt-4">
                            <select name="searchCategoryInput2" id="searchCategoryInput2" class="w-full border rounded-lg p-4 text-sm text-gray-900 border-gray-300 bg-gray-50">
                        ...
                        <div class="w-1/2 sm:w-full mt-4">
                            <label for="searchInput2" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">Search</label>
                            <div class="relative">
                                ...
                                <input type="search" id="searchInput2" class="block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Type your favourite..." required />
                                <button type="button" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onclick="searchProducts()">Search</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="w-full flex flex-wrap justify-center gap-5 mt-6 px-2 py-5 rounded-lg">
                        ...
                        <?php
                        $product_rs = Database::search("SELECT foods.id AS food_id, foods.name AS food_name, food_details.id AS food_details_id, sub_category.id AS sub_category_id, sub_category.name AS sub_category_name, foods.*, food_details.*, sub_category.* FROM foods INNER JOIN food_details ON foods.id = food_details.foods_id INNER JOIN sub_category ON foods.sub_category_id = sub_category.id ORDER BY foods.date_time_added DESC");
                        ...
                        ?>
                            ...
                            <div class="rounded-lg slide-w-h-prd border border-gray-300 shadow-lg flex flex-col items-center">
                                ...
                                <div class="w-full px-3 mt-2 flex flex-col">
                                    <a href='<?php echo "updateProduct.php?id=" . $product_data["food_id"]; ?>' class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-1  mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 w-full rajdhani-light text-center">Update</a>
